            ...
            do
            {
                ...
                switch (paymentOption)//payment option checking 
                {
                    ...
                    case 2:
                        ...
                        Console.WriteLine("Enter Expiration Date (For Example: 1019");
                        ...
                        while(expirationDate<0816)    //year validation
                        {
                    ...
                    case 3:
                        ...
                        try
                        {
                            accountNumberLong = long.Parse(accountNumber);
                        }
                        catch (FormatException ex)
                        {
                            Console.WriteLine(ex.Message.ToString());
                            ...
                            accountNumberLong = long.Parse(Console.ReadLine());
                        }
